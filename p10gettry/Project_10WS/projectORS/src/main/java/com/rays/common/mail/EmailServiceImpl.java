...
public class EmailServiceImpl {
	...
	public void send(EmailDTO dto, UserContext ctx) {
		...
		if (dto.getMessageCode() != null) {
			...
			System.out.println(messageDTO.getSubject(dto.getMessageParams()) + "68 line Inside Emailserviceimpl...........");
		...
		MimeMessage message = emailSender.createMimeMessage(); // mimemessage class
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				emailSender.send(message);       //javamailsender class
			}
		}).start();
